...
function calculate()
    {
       ...
       var d=document.form1.txtbactch.value;
       ...
       var g=document.form1.txtc.value;
       document.getElementById("democ").innerHTML=g;
       ...
       document.getElementById("demototal").innerHTML=txt2.toFixed(2)+"%";
